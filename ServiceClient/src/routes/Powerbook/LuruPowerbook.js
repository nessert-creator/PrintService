    ...
    return (<div className={styles.container}>
        ...
        rules: [{ required: true, message: '请输入客户名称！' }]
						...
						<FormItem label="证件类型:" {...formCol}>
							{getFieldDecorator('type_1', {})(<Select style={{ width: 200 }} onChange={handleChange}>
						...
						<FormItem label="联系电话:" {...formCol}>
							{getFieldDecorator('phoneNumber_1', {})(<Input className={styles.input}/>)}
						</FormItem>
						<hr />
						...
						<FormItem label="联系电话:" {...formCol}>
							{getFieldDecorator('phoneNumber_2', {})(<Input className={styles.input}/>)}
						</FormItem>
						<hr />
						<div>
