 ...
 * 
 * @export
 * @interface CreatePowerbookDemoDto
 */
export interface CreatePowerbookDemoDto {
    /**
     * 
     * @type {string}
     * @memberof CreatePowerbookDemoDto
     */
    sname?: string;
    /**
     * 法定代表人信息
...
export const PowerbookApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        appPowerbookCreate(input: CreatePowerbookDemoDto, X_XSRF_TOKEN?: string, authorization?: string, options: any = {}): FetchArgs {
            // verify required parameter 'input' is not null or undefined
            if (input === null || input === undefined) {
            ...
            delete localVarUrlObj.search;
            localVarRequestOptions.headers = Object.assign({}, localVarHeaderParameter, options.headers);
            const needsSerialization = (<any>"CreatePowerbookDemoDto" !== "string") || localVarRequestOptions.headers['Content-Type'] === 'application/json';
            localVarRequestOptions.body =  needsSerialization ? JSON.stringify(input || {}) : (input || "");
...
export const PowerbookApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        appPowerbookCreate(input: CreatePowerbookDemoDto, X_XSRF_TOKEN?: string, authorization?: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<GetListPowerbookDto> {
...
export const PowerbookApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
         ...
         * @throws {RequiredError}
         */
        appPowerbookCreate(input: CreatePowerbookDemoDto, X_XSRF_TOKEN?: string, authorization?: string, options?: any) {
...
export class PowerbookApi extends BaseAPI {
     ...
     */
    public appPowerbookCreate(input: CreatePowerbookDemoDto, X_XSRF_TOKEN?: string, authorization?: string, options?: any) {
