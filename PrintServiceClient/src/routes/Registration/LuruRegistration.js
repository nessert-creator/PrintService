    ...
    return (<div className={styles.container}>
                            ...
                            <Row className={styles.block}>
                                <Col span={7}>
                                    <FormItem label='性别' {...formCol}>
                                        {getFieldDecorator('gender_1', {})(<Radio.Group name="性别" defaultValue={1}>
                            ...
                            <Row className={styles.block}>
                                <Col>
                                    <FormItem label='职业' {...formCol} style={{ position: 'relative', left: '-624px' }}>
                                        {getFieldDecorator('professional', {})(<Row style={{ width: '200%', position: 'relative', left: '711px', top: '-37px' }}>
                                                <Col span={2}>
                                                    <Radio onChange={() => {
        ...
        changeTax("既是中国税收居民又是其他国家(地区)税收居民");
                            ...
                            <Row className={styles.block}>
                                <Col>
                                    <FormItem label='美国纳税人识别号' {...formCol_2}>
                                        {getFieldDecorator('number_2', {})(<div>
                            ...
                            <Row className={styles.block}>
                                ...
                                <Col span={7}>
                                    <FormItem label='性别' {...formCol}>
                                        {getFieldDecorator('gender_2', {})(<Radio.Group name="radiogroup" defaultValue={1}>
        ...
        changeRiqi_2("长期");
                            ...
                            <Row className={styles.block}>
                                <Col style={{ width: '50%', marginLeft: '-33px', marginTop: '15px' }}>
                                    <FormItem label='联系地址' {...formCol}>
                                        {getFieldDecorator('province', {})(<Input style={{ width: '100px' }}/>)}
                                        <span>省/自治区/直辖市</span>
                                    </FormItem>
                                </Col>
                                <Col style={{ width: '37%', marginLeft: '320px', marginTop: '-56px' }}>
                                    <FormItem label='' {...formCol}>
                                        {getFieldDecorator('city', {})(<Input style={{ width: '100px' }}/>)}
                                        <span>市/区/县</span>
                                    </FormItem>
                                </Col>
                                <Col className={styles.area}>
                                    <FormItem label='' {...formCol}>
                                        {getFieldDecorator('area', {})(<Input style={{ width: '100px' }}/>)}
                                        <span>街道/小区/门牌号</span>
                                    </FormItem>
                                </Col>
                            </Row>
                            ...
                            <Row className={styles.block}>
                                <Col>
                                    <FormItem label='行业' {...formCol}>
                                        {getFieldDecorator('industry', {})(<Row>
                                                <Col span={5}>
                                                    <Radio onChange={() => {
                            ...
                            <Row className={styles.block}>
                                <Col>
                                    <FormItem label='职务' {...formCol}>
                                        {getFieldDecorator('professiona2', {})(<Row>
                                                <Col span={5}>
                                                    <Radio onChange={() => {
                            ...
                            <Row className={styles.block}>
                                ...
                                <Col>
                                    <FormItem label='签名' {...formCol}>
                                        {getFieldDecorator('signature', {})(<Input className={styles.input}/>)}
                                    </FormItem>
                                </Col>
