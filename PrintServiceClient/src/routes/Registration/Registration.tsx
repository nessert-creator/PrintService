...
function Registration({ form, record }) {
	...
	return (
		<CRUD
			form={form}
			getAllApi={new api.RegistrationApi().appRegistrationGetAll}
			deleteApi={new api.RegistrationApi().appRegistrationDelete}
			updateApi={new api.RegistrationApi().appRegistrationUpdate}
			createApi={new api.RegistrationApi().appRegistrationCreate}
			columns={columns}
			formNode={formNode}
