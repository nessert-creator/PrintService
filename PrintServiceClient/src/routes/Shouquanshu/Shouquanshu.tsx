...
function Shouquanshu({ form, record }) {
    ...
    return (
        <CRUD
            form={form}
            getAllApi={new api.ShouquanshuApi().appShouquanshuGetAll}
            deleteApi={new api.ShouquanshuApi().appShouquanshuDelete}
            updateApi={new api.ShouquanshuApi().appShouquanshuUpdate}
            createApi={new api.ShouquanshuApi().appShouquanshuCreate}
            columns={columns}
            formNode={formNode}
