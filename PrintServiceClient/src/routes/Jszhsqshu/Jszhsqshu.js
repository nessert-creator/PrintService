...
function Jszhsqshu({ form, record }) {
    ...
    return (<CRUD form={form} getAllApi={new api.JszhsqshuApi().appJszhsqshuGetAll} deleteApi={new api.JszhsqshuApi().appJszhsqshuDelete} updateApi={new api.JszhsqshuApi().appJszhsqshuUpdate} createApi={new api.JszhsqshuApi().appJszhsqshuCreate} columns={columns} formNode={formNode} customColumnOption={(text, record) => (<span>
                <a onClick={() => {
        dispatch({
