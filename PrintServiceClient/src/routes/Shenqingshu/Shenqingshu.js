...
function Shenqingshu({ form, record }) {
    ...
    return (<CRUD form={form} getAllApi={new api.ShenqingshuApi().appShenqingshuGetAll} deleteApi={new api.ShenqingshuApi().appShenqingshuDelete} updateApi={new api.ShenqingshuApi().appShenqingshuUpdate} createApi={new api.ShenqingshuApi().appShenqingshuCreate} columns={columns} formNode={formNode} customColumnOption={(text, record) => (<span>
                    <a onClick={() => {
        dispatch({
