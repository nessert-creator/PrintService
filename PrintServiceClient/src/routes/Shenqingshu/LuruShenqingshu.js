						...
						<Row>
							<Col span={12}>
								...
								<FormItem className={styles.formItem}>
									{getFieldDecorator('AccountName', {})(<Input className={styles.input}/>)}
								</FormItem>
							</Col>
							<Col span={12}>
								<span>账号</span>
        ...
        rules: [{ message: '请输入金额！' }]
						...
						<Row>
							...
							<Col>
								...
								<span>支取日</span>
								<FormItem className={styles.formItem}>
									{getFieldDecorator('WithdrawalDate', {})(<Input className={styles.input}/>)}
								</FormItem>
							</Col>
							<Col>
						...
						<Row>
							...
							<Col>
								<span>凭证号码</span>
								<FormItem className={styles.formItem}>
									{getFieldDecorator('VoucherNumber', {})(<Input className={styles.input}/>)}
								</FormItem>
								<span>网银流水号</span>
								<FormItem className={styles.formItem}>
									{getFieldDecorator('Liushuihao', {})(<Input className={styles.input}/>)}
								</FormItem>
							</Col>
						</Row>
						<Row>
							...
							<span>票据种类</span>
							<FormItem className={styles.formItem}>
								{getFieldDecorator('Zhonglei', {})(<Input className={styles.input}/>)}
							</FormItem>
							<span>票据号码</span>
							<FormItem className={styles.formItem}>
								{getFieldDecorator('Haoma', {})(<Input className={styles.input}/>)}
							</FormItem>
							<span>金额</span>
							<FormItem className={styles.formItem}>
								{getFieldDecorator('Jianer', {})(<Input className={styles.input}/>)}
							</FormItem>
							</Col>
							<Col>
							<span>收款人名称</span>
							<FormItem className={styles.formItem}>
								{getFieldDecorator('Shoukuanren', {})(<Input className={styles.input}/>)}
							</FormItem>
							<span>出票日期</span>
							<FormItem className={styles.formItem}>
								{getFieldDecorator('Chupiaoriqi', {})(<Input className={styles.input}/>)}
							</FormItem>
							<span>票据到期日</span>
							<FormItem className={styles.formItem}>
								{getFieldDecorator('Daoqiri', {})(<Input className={styles.input}/>)}
							</FormItem>
							</Col>
							<Col>
							<span>票据丧失时间</span>
							<FormItem className={styles.formItem}>
								{getFieldDecorator('Sangshishijian', {})(<Input className={styles.input}/>)}
							</FormItem>
							
							<span>地点</span>
							<FormItem className={styles.formItem}>
								{getFieldDecorator('Didian', {})(<Input className={styles.input}/>)}
							</FormItem>
							<span>原因</span>
							<FormItem className={styles.formItem}>
								{getFieldDecorator('Yuanyin', {})(<Input className={styles.input}/>)}
							</FormItem>
							</Col>
						...
						<Row>
							...
							<span>截止日期</span>
							<FormItem className={styles.formItem}>
								{getFieldDecorator('Jiezhiriqi', {})(<Input className={styles.input}/>)}
							</FormItem>
							<span>说明</span>
							<FormItem className={styles.formItem}>
								{getFieldDecorator('Shuoming', {})(<Input className={styles.input}/>)}
							</FormItem>
							</Col>
							<span>预留印鉴业务</span>
							<FormItem className={styles.formItem}>
							...
							<span>变更原因</span>
							<FormItem className={styles.formItem}>
								{getFieldDecorator('Biangengyuanyin', {})(<Input className={styles.input}/>)}
							</FormItem>
							<Col>
							<span>注销现有印鉴，建立共用关系</span>
							<span>主账号</span>
							<FormItem className={styles.formItem}>
								{getFieldDecorator('Zhuzhanghao', {})(<Input className={styles.input}/>)}
							</FormItem>
							</Col>
							<Col>
							...
							<span>原主账号</span>
							<FormItem className={styles.formItem}>
								{getFieldDecorator('Yuanzhanghao', {})(<Input className={styles.input}/>)}
							</FormItem>
							<span>新主账号</span>
							<FormItem className={styles.formItem}>
								{getFieldDecorator('Xinzhanghao', {})(<Input className={styles.input}/>)}
							</FormItem>
							</Col>
...
LuruShenqingshu = connect((state) => {
    return Object.assign({}, state.shenqingshu);
})(LuruShenqingshu);
