...
function Powerbook({ form, record }) {
    ...
    return (<CRUD form={form} getAllApi={new api.PowerbookApi().appPowerbookGetAll} deleteApi={new api.PowerbookApi().appPowerbookDelete} updateApi={new api.PowerbookApi().appPowerbookUpdate} createApi={new api.PowerbookApi().appPowerbookCreate} columns={columns} formNode={formNode} customColumnOption={(text, record) => (<span>
					<a onClick={() => {
        dispatch({
