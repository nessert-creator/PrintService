...
function Bgyhjszhsqss({ form, record }) {
	...
	return (
		<CRUD
			form={form}
			getAllApi={new api.BgyhjszhsqssApi().appBgyhjszhsqssGetAll}
			deleteApi={new api.BgyhjszhsqssApi().appBgyhjszhsqssDelete}
			updateApi={new api.BgyhjszhsqssApi().appBgyhjszhsqssUpdate}
			createApi={new api.BgyhjszhsqssApi().appBgyhjszhsqssCreate}
			columns={columns}
			formNode={formNode}
