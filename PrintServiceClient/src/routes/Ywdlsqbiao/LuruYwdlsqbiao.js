        ...
        rules: [{ required: true, message: '请输入客户名称！' }]
							...
							<Row>
								<Col span={12}>
									...
									<FormItem label="证件类型" {...formCol}>
										{getFieldDecorator('certificatetype', {})(<Input className={styles.input}/>)}
									</FormItem>
									<FormItem label="证件号码" {...formCol}>
										{getFieldDecorator('idnumber', {})(<Input className={styles.input}/>)}
									</FormItem>
									<FormItem label="联系电话" {...formCol}>
										{getFieldDecorator('contactnumber', {})(<Input className={styles.input}/>)}
									</FormItem>
								</Col>
								<Col span={12}>
									<FormItem label="姓名" {...formCol}>
									...
									<FormItem label="证件类型" {...formCol}>
										{getFieldDecorator('certificatetype2', {})(<Input className={styles.input}/>)}
									</FormItem>
									<FormItem label="证件号码" {...formCol}>
										{getFieldDecorator('idnumber2', {})(<Input className={styles.input}/>)}
									</FormItem>
									<FormItem label="联系电话" {...formCol}>
										{getFieldDecorator('contactnumber2', {})(<Input className={styles.input}/>)}
									</FormItem>
								</Col>
							</Row>
							...
							<Row>
								<Col span={12}>
									...
									<FormItem label="证件类型" {...formCol}>
										{getFieldDecorator('certificatetype1', {})(<Input className={styles.input}/>)}
									</FormItem>
									<FormItem label="证件号码" {...formCol}>
										{getFieldDecorator('idnumber1', {})(<Input className={styles.input}/>)}
									</FormItem>
									<FormItem label="联系电话" {...formCol}>
										{getFieldDecorator('contactnumber1', {})(<Input className={styles.input}/>)}
									</FormItem>
								</Col>
								<Col span={12}>
...
LuruYwdlsqbiao = connect((state) => {
    return Object.assign({}, state.ywdlsqbiao);
})(LuruYwdlsqbiao);
